...
class config {
    ...
    private function __construct() {
        $this->config = get_config('local_exammode');
    }

    public function get_roletohideblock() {
        return $this->config->roletohideblock;
    }
    public function get_roletosystem() {
        return $this->config->roletosystem;
    }
}
